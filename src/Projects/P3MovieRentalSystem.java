...
Loop through the movieTitles array and use if-else statements to determine which movies are appropriate for the user's age range based on the movie ratings.
